...
"""
Understanding the following two examples is beneficial for you to move to the exercises below.
This is an example that uses turtle to draw steps 10 pixels by 10 pixels. 
"""
...
which is the angle your turtle pen will turn.
...
You can review the concept of exterior angles of regular polygons from here:
...
def draw_regular_polygon(num_sides, side_length):
    ...
    pen = turtle.Turtle()
    pen.speed(1)
    exterior_angle = 360 / 6  # Calculate the exterior angle of a regular polygon
...
to your GitHub repository, as you did for lab1 and lab2. That's all!
"""